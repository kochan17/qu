...
Que の「<画面名>」画面を image-2 で生成する。Home 画面 `/Users/kotaishida/projects/personal/qu/.stitch/designs/home-desktop-final.png` と揃ったデザイン言語・サイドバー・トーンで。
...
3. 以下のファイルを Codex に読ませる:
   - `/Users/kotaishida/projects/personal/qu/.stitch/prompts-screens.md` ← §共通プリアンブル と §<番号> <画面名> を使う
   - `/Users/kotaishida/projects/personal/qu/.stitch/designs/home-desktop-final.png` ← 参照画像
4. 「共通プリアンブル + §<番号>」を結合したプロンプトで生成
5. `/Users/kotaishida/projects/personal/qu/.stitch/designs/<screen-slug>-<form>-final.png` に保存
6. ファイル確認し、パスとサイズを報告
